...
def main():
    # Load your responses
    input_file = "refusal_responses/qwen7b_ppo_web/qwen_refusal_full_search_base_web.json"
    output_file = "eval_results/qwen7b_ppo_web/qwen_results_refusal_full_search_base_web.json"
