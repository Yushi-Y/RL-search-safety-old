...
def main():
    # Load your responses
    input_file = "refusal_responses/llama3b_ppo_web/llama_refusal_full_search_prefill_2_once_web.json"
    output_file = "eval_results/llama3b_ppo_web/llama_results_refusal_full_search_prefill_2_once_web.json"
