...
def main():
    # Load your responses
    input_file = "refusal_responses/llama3b_ppo_local/llama_refusal_full_search_prefill_3_once.json"
    output_file = "eval_results/llama3b_ppo_local/llama_results_refusal_full_search_prefill_3_once.json"
