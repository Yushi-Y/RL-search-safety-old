...
def main():
    # Load your responses
    input_file = "refusal_responses/qwen7b_ppo_local/qwen_refusal_full_search_prefill_1_once_v2.json"
    output_file = "eval_results/qwen7b_ppo_local/qwen_v2_results_harm_full_search_prefill_1_once.json"
