...
def main(input_file=None, output_file=None):
    ...
    if input_file is None:
        input_file = "/data/kebl6672/AGENTIC-RL/refusal_responses/qwen7b_ppo_local/qwen_refusal_full_search_prompt_1.json"
    if output_file is None:
        output_file = "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_local/search_eval_qwen_refusal_full_search_prompt_1.json"
