...
def process_single_question(question_text):
    ...
    is_first_iteration = True  # Track if this is the first iteration to add prefilled "<search>"
    ...
    while True:
        ...
        if outputs[0][-1].item() in curr_eos:
            ...
            # Add the prefilled "<search>" only on first iteration
        ...
        is_first_iteration = False  # After first iteration, no longer prefilled
...
def main():
    ...
    try:
        # Try with name parameter (for configurations)
