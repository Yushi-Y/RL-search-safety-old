...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_4.json"
...
def process_single_question(question_text):
    ...
    # Prefill with "<think> I need to" only once at the beginning
    current_prompt += "<think> I need to"
