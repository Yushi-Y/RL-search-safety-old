...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_hereare.json"
...
def process_single_question(question_text):
    ...
    # Prefill with "Here are the steps: " only once at the beginning
    current_prompt += "Here are the steps: "
    ...
    while True:
        ...
        if outputs[0][-1].item() in curr_eos:
            ...
            full_response += "Here are the steps: " + output_text
            print("Here are the steps: " + output_text)
            break
        ...
        search_text = curr_search_template.format(output_text="Here are the steps: " + output_text, search_results=search_results)
