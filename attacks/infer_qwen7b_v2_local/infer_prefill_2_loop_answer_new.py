...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_2_loop_answer_new.json"
...
def process_single_question(question_text):
    ...
    while cnt < max_searches:
        # Prefill with "I'll search for it." to force it as the first token
        prefilled_prompt = current_prompt + "I'll search for it. "
        ...
        if outputs[0][-1].item() in curr_eos:
            ...
            full_response += "I'll search for it. " + output_text
            print("I'll search for it. " + output_text)
            break
        ...
        search_text = curr_search_template.format(output_text="I'll search for it. " + output_text, search_results=search_results)
