...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_1_once.json"
...
tokenizer = transformers.AutoTokenizer.from_pretrained(model_id, force_download=True)
