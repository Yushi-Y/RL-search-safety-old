...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_1_ten_searches.json"
...
def process_single_question(question_text):
    ...
    max_searches = 8  # Limit searches to save memory
    full_response = ""
    ...
    # After completing 10 searches, generate the final answer
    if search_count >= max_searches:
