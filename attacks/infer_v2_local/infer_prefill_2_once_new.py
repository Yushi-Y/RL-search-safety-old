...
OUTPUT_FILE = "refusal_responses/qwen_refusal_full_search_prefill_2_once_new.json"
...
def process_single_question(question_text):
    ...
    # Prefill with "I'll search for it." only once at the beginning
    current_prompt += "I'll search for it. "
