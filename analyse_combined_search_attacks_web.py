#!/usr/bin/env python3
"""
Combined analysis script to compare different search attack strategies for WEB datasets:
- IT search (web) (5 positions)
- Base search (web) (5 positions) 
- Search attack average (web) (5 positions) - average of middle lines from search datasets
- Multi-search attack average (web) (10 positions) - average of all lines from multi-search datasets
"""
...
def main():
    # File paths for search datasets (first 5 positions) - WEB ONLY
    search_datasets = {
        'search_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_web.json",
        'base_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_base_web.json",
        'prefill_1_once_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_1_once_web.json",
        'prefill_2_once_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_2_once_web.json",
        'prefill_3_once_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_3_once_web.json",
        'prompt_1_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prompt_1_web.json",
        'prompt_2_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prompt_2_web.json"
    }
    
    # File paths for multi-search datasets (up to 10 positions) - WEB ONLY
    multi_search_datasets = {
        'search_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_web.json",
        'base_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_base_web.json",
        'prompt_1_ten_searches_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prompt_1_ten_searches_web.json",
        'prompt_2_ten_searches_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prompt_2_ten_searches_web.json",
        'prefill_1_loop_answer_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_1_loop_answer_web.json",
        'prefill_2_loop_answer_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_2_loop_answer_web.json",
        'prefill_3_loop_answer_web': "/data/kebl6672/AGENTIC-RL/eval_results/qwen7b_ppo_web/search_eval_qwen_refusal_full_search_prefill_3_loop_answer_web.json"
    }
    
    print("Loading web search datasets...")
    ...
    print("\nLoading web multi-search datasets...")
    ...
    # Print statistics
    print(f"\n" + "="*80)
    print("COMBINED SEARCH ATTACK ANALYSIS - WEB DATASETS")
    print("="*80)
    ...
    print(f"\nSearch Attack Average (web) (5 positions):")
    for pos in range(1, 6):
        if pos in search_attack_avg:
            print(f"  Position {pos}: {search_attack_avg[pos]:.3f}")
    
    print(f"\nMulti-Search Attack Average (web) (10 positions):")
    ...
    # Plot IT Search (web) (5 positions)
    if it_search_avg:
        ...
        plt.plot(it_positions, it_scaled, 'o-', label='IT Search (web)', color='#228B22', linewidth=3, markersize=10)
    ...
    # Plot Base Search (web) (5 positions)
    if base_search_avg:
        ...
        plt.plot(base_positions, base_scaled, 'X-', label='Base Search (web)', color='#DC143C', linewidth=3, markersize=10)
    ...
    # Plot Search Attack Average (web) (5 positions)
    if search_attack_avg:
        ...
        plt.plot(search_attack_positions, search_attack_scaled, 's-', label='Search Attack (web)', color='#6BAED6', linewidth=3, markersize=10)
    ...
    # Plot Multi-Search Attack Average (web) (5 positions only)
    if multi_search_attack_avg:
        ...
        plt.plot(multi_search_positions, multi_search_scaled, '^-', label='Multi-Search Attack (web)', color='#FDAE6B', linewidth=3, markersize=10)
    ...
    # Save the plot
    output_path = "/data/kebl6672/AGENTIC-RL/figures/combined_search_attacks_web_first_5_positions.png"
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"\nCombined search attacks comparison plot (web) saved to: {output_path}")
    
    # Save detailed results
    results = {
        'it_search_web': it_search_avg,
        'base_search_web': base_search_avg,
        'search_attack_average_web': search_attack_avg,
        'multi_search_attack_average_web': multi_search_attack_avg,
        'search_attack_datasets_web': search_attack_datasets,
        'multi_search_attack_datasets_web': multi_search_attack_datasets
    }
    
    results_path = "/data/kebl6672/AGENTIC-RL/figures/combined_search_attacks_web_first_5_positions_results.json"
