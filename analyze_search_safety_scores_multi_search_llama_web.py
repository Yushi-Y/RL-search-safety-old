#!/usr/bin/env python3
"""
Multi-dataset analysis script to compare average harm scores for search queries between llama web datasets:
...
def main():
    # File paths for all llama web datasets
    datasets = {
        'search_web': "/data/kebl6672/ARL/eval_results/llama3b_ppo_web/search_eval_llama_refusal_full_search_web.json",
    ...
    print(f"\n" + "="*80)
    print("HARM SCORES BY QUERY POSITION (ALL POSITIONS) - LLAMA WEB DATASETS")
    print("="*80)
    ...
    print(f"\n" + "="*80)
    print("QUESTIONS BY NUMBER OF SEARCH QUERIES - LLAMA WEB DATASETS")
    print("="*80)
    ...
    # Save the plot
    output_path = "/data/kebl6672/ARL/figures/multi_search_safety_scores_llama_web_10_positions.png"
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"\nSearch safety scores line plot (llama web) saved to: {output_path}")
    
    # Create a comparison table for all positions
    print(f"\n" + "="*80)
    print("COMPARISON TABLE - ALL POSITIONS (LLAMA WEB DATASETS)")
    print("="*80)
    ...
    print(f"\n" + "="*80)
    print("QUERY COUNT DISTRIBUTION COMPARISON TABLE (LLAMA WEB DATASETS)")
    print("="*80)
    ...
    results_path = "/data/kebl6672/ARL/figures/multi_search_safety_scores_llama_web_results.json"
