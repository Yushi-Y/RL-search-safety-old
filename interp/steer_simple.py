"""
Steering with simple generation (NO search attack).

Approach:
1. Load direction extracted from IT model (refusal or search_clean)
...
def main():
    ...
    output_file = output_dir / f"steering_results_{DIRECTION_TYPE}_simple.json"
