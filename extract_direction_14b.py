"""
Extract harmful search direction from base Qwen2.5-14B-Instruct and SearchR1 models.
...
SEARCHR1_MODEL = "PeterJinGo/SearchR1-nq_hotpotqa_train-qwen2.5-14b-it-em-grpo-v0.3"
OUTPUT_DIR = Path("/VData/kebl6672/ARL/direction_analysis_14b")
...
LAYER_INDICES = [24, 30, 36, 42, 48]  # For Qwen 14B (48 layers total, 48 is last layer)
